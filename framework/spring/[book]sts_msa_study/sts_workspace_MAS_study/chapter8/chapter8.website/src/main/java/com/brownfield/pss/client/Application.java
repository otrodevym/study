...
//		SearchQuery searchQuery = new SearchQuery("NYC","SFO","22-JAN-18");
        SearchQuery searchQuery = new SearchQuery("SEA", "SFO", "22-JAN-18");
...
// 		Flight[] flights = restClient.postForObject("http://localhost:8090/search/get", searchQuery, Flight[].class); 
// 		Flight[] flights = restClient.postForObject("http://search-service/search/get", searchQuery, Flight[].class); 
        Flight[] flights = restClient.postForObject("http://search-apigateway/api/search/get", searchQuery,
                Flight[].class);

        // Flight[] flights =
        // searchClient.postForObject("http://localhost:8083/search/get", searchQuery,
        // Flight[].class);
