package com.otrodevym.web.oauth;
...
import com.otrodevym.web.oauth2.OAuth2Provider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	*/
	 ...
	 * oAuth2ClientProperties.getRegistration().keySet().stream() .map(client ->
	 ...
	 * .clientId(kakaoClientId) .clientSecret("test") .jwkSetUri("test") .build());
	 * return new InMemoryClientRegistrationRepository(registrations); }
	 */

	/*
	 * private Object getRegistration(OAuth2ClientProperties clientProperties,
	 * String client) { if("google".contentEquals(client)) {
	 * OAuth2ClientProperties.Registration registration =
	 * clientProperties.getRegistration().get("google"); return
	 * CommonOAuth2Provider.GOOGLE.getBuilder(client)
	 * .clientId(registration.getClientId())
	 * .clientSecret(registration.getClientSecret()) .scope("email",
	 * "profile").build(); } if("facebook".equals(client)) {
	 * OAuth2ClientProperties.Registration registration =
	 * clientProperties.getRegistration().get("facebook"); return
	 * CommonOAuth2Provider.FACEBOOK.getBuilder(client)
	 * .clientId(registration.getClientId())
	 * .clientSecret(registration.getClientSecret())
	 * .userInfoUri("https://graph.facebook.com/me?fields=id,name,email,link")
	 * .scope("email") .build(); } return null; }
	 */
