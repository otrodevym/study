...
// var errorHandler = async function (error) {
...
// });
// //빌드
// gulp.task('build', gulp.parallel('uglify', 'minifycss', 'minifyhtml'));
...
// 	return runSequence('build', gulp.parallel('server', 'watch'), done);
// });
